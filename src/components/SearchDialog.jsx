...
const searchData = [
  {
    ...
    path: '/',
    keywords: ['home', 'cv', 'resume', 'start', 'welcome', 'portfolio', 'jagdish', 'jagdish patil', 'python developer', 'full stack developer', 'web developer'],
  },
  {
    title: 'About',
    description: 'Learn more about me and my background',
    path: '/about',
    keywords: ['about', 'background', 'education', 'bio', 'profile', 'cv', 'resume', 'jagdish', 'patil', 'python developer', 'software developer'],
  },
  {
    title: 'Education',
